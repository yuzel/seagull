  ...
  return (
    <div>
      <div className={styles.resume}>
        <img className={styles.resumeImg} src={resume} alt="" />
      </div>
      <div className={styles.photo}>
        <img className={styles.resumeImg} src={photo} alt="" />
        <div style={{ paddingLeft: 48 }}>
          ...
          <p>
            <span className={styles.projectTime}>2014.3-2016.4</span>
            <span className={styles.project}>军朗广告（设计）有限公司       视觉设计</span>
          </p>
          <p>
            <span className={styles.projectTime}>2013.9-2014.3</span>
            <span className={styles.project}>新锐风格设计有限公司（山西） 平面设计</span>
          </p>
        </div>
      </div>
    </div>
